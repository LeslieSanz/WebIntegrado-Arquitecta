...
<%@ page import="modelo.Curso,dao.cursoDAO" %>
<!DOCTYPE html>
<html>
<head>
        ...
        <main class="app-main">
            ...
            <div class="app-content-header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Reporte de cursos por año</h3>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                <li class="breadcrumb-item"><a href="#">Grafico 2</a></li>
                            ...
                            <tbody>
                                <% String anParam1 = request.getParameter("tan");
                                    ...
                                    if (anParam1 != null && tipo1 != null) {
                                        ...
                                        for (Curso x : obj.LisCantCursosPorAnio(an)) {
                                %>
                                <tr>
                                    <td><%= x.getNombre()%></td>
                                    <td><%= x.getCantCompras()%></td>
                                </tr>
                                <%      }
                                    }
                                %>
